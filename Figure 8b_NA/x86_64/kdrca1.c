...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kdr /fp/homes01/u01/ec-huah/FFI_onHPC/MOD_for_MPI_240519/kdrca1.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/fp/homes01/u01/ec-huah/FFI_onHPC/MOD_for_MPI_240519/kdrca1.mod";
static const char* nmodl_file_text = 
  "TITLE K-DR channel\n"
