...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 NMDA /fp/homes01/u01/ec-huah/FFI_onHPC/MOD_for_MPI_240519/NMDA_240512.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/fp/homes01/u01/ec-huah/FFI_onHPC/MOD_for_MPI_240519/NMDA_240512.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  ...
  "	g = B - A\n"
  "	i = g*(v - e)/(1+0.3*exp(-0.08*v)) :the voltage dependence is based on Farinella M and Silver RA, 2014, Plos computational biology\n"
  "}\n"
  "\n"
  "DERIVATIVE state {\n"
  "	A' = -A/tau1\n"
