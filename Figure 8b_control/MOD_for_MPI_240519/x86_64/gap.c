...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "pointer");
 	...
 	ivoc_help("help ?1 gap /fp/homes01/u01/ec-huah/FFI_onHPC/MOD_for_MPI_240519/gap.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/fp/homes01/u01/ec-huah/FFI_onHPC/MOD_for_MPI_240519/gap.mod";
static const char* nmodl_file_text = 
  "NEURON {THREADSAFE\n"
  "	POINT_PROCESS gap\n"
